...
func NewTask(taskId int, m map[string]interface{}, request interface{}, roomId int) *Task {
	return &Task{
		TaskId:      taskId,
		Map:         m,
		RoomId:      roomId,
...
func NewTask2(taskId int, m map[string]any, request interface{}, roomId int, leftTime float64) *Task {
	return &Task{
		TaskId:      taskId,
		Map:         m,
		RoomId:      roomId,
